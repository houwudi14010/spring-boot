...
<!-- 引入fileinput的css -->
<link type="text/css" rel="stylesheet" href="${base}/static/js/fileinput/css/fileinput.min.css" />
<!-- 引入fileinput的css -->
...
<!-- 引入fileinput的js -->
<script type="text/javascript" src="${base}/static/js/fileinput/js/fileinput.min.js"></script>
<!--  引入fileinput的js -->         
<script type="text/javascript" src="${base}/static/js/fileinput/js/locales/zh.js"></script>
                       
<script type="text/javascript" src="${base}/static/js/fileinput/themes/fa/theme.js"></script>
...
<body>
		...
		<input type="hidden" name="id">
					    ...
					    <input type="text" name="name" value="${userBeanTwo.name}" id="uuid-busId">
						
					    <input type="radio" name="sex" value="1" ${userBeanTwo.sex}==1?"checked":"">男
					    
					    <input type="radio" name="sex" value="2" ${userBeanTwo.sex}==2?"checked":"">女
		
					    <input type="text" name="hobby" value="${userBeanTwo.hobby}">
					   
			
					    <input type="text" name="nickname" value="${userBeanTwo.nickname}">
